...
var productArray = ["Shirts: 19.99", "Pants: 30.61", "Caps: 7.88", "Tshirts: 15.50"];
...
for(let i = 0; i < productArray.length; i++){
    ...
    // STEP 8: Build the string that contains two TD elements each containing one of the item description, 
    //and the item price
    var tableTd = "<td>" + productDesc + "</td><td>$" + productPrice + "</td>"; // <td>productDesc</td><td>productPrice</td>
    // STEP 9: Set the above string as the innerHTML of the new TR element, and then append the 
    //new element to the table body (var productList)
    tableTr.innerHTML = tableTd;
    console.log(tableTr);
    productBody.appendChild(tableTr);
    // STEP 10: Set the total cost of the invoice as the textContent of the TD in the 
    //TFOOT (var totalData), rounding the number to two decimal places
